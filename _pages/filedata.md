...
* ./komik.sh -c Konjiki no Moji Tsukai
...
* ./komik.sh -c Tale of a Scribe Who Retires to the Countryside
...
* ./komik.sh -c The Strongest in History
...
* ./komik.sh -c Ancestor of The Gods
